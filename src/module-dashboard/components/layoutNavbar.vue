<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      <el-button type="primary" class="item" icon="el-icon-printer" id="organButton" size="small" circle>机构人员</el-button>
      <!-- 站内搜索 -->
      <div class="item">
      ...
      <el-dropdown class="item">
        <span class="el-dropdown-link">
          <img class="avatar" src="../assets/bigUserHeader.png"> {{loginEname}}
