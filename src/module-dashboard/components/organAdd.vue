        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="登记日期" prop="dateRegister">
              <el-date-picker v-model="formBase.dateRegister" type="datetime" placeholder="选择日期时间" default-time="12:00:00">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="有效日期" prop="dateValid">
              <el-date-picker v-model="formBase.dateValid" type="datetime" placeholder="选择日期时间" default-time="12:00:00">
              </el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    createData(formBase) {
      ...
      organData.data.dateRegister=formBase.dateRegister;
      organData.data.dateValid=formBase.dateValid;
      var testData = JSON.stringify(organData);
      ...
      if (this.text == "创建") {
        ...
        updateInstitutes(organData).then(response => {
          if (response.data.result == 1) {
            const jsonData = response.data;
            this.$emit('getList');
          } else {
